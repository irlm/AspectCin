 ...
 * Transactions) + Spring Transactions, in a JTA environment</p>
 *
 ...
 */
public class SimpleEJBWithCmtAndSpringTx extends AbstractStatelessSessionBean
	...
	protected static final Log logger = LogFactory
			.getLog(SimpleEJBWithCmtAndSpringTx.class);
	...
	public String echo(String input) {
		return "(SimpleEJBWithCmtAndSpringTx: hello " + input + ")";
	}
