/*
 * $Id: FilterMatchByTypeAndSource.java,v 1.5 2003/07/09 19:56:28 ravip Exp $
 */
...
public class FilterMatchByTypeAndSource implements FilterNode {
	...
	public int pushEvent (EventCarrier ec, int eventnum)
	{
		...
		if (lastFired_ != eventnum) {
			...
			if ((type == typeToMatch_ || typeToMatch_ == FilterOpTypes.TYPE_ANY) &&
                            (source == sourceToMatch_ || sourceToMatch_ == FilterOpTypes.SOURCE_ANY)) {
