...
final class DeserializationKernelSun15 implements DeserializationKernel
{
    ...
    private Field getAccessibleField( final Class c, final String n )
    {
        ...
        catch ( final NoSuchFieldException e )
        {
            throw ExceptionTool.initCause(
                    new Error( "Field [" + n + "] could not be found on class [" + c + "]" ), e );
        }
    }
        ...
        throws InstantiationException, IllegalAccessException
    {
        ...
        {
            // TODO: use getCause() after converting OpenORB to JDK 1.4
            ...
            throw ExceptionTool.initCause( new Error( "Unexpected exception ("
                    + cause + ")" ), cause );
        }
    }
    ...
    public void setObjectField ( final Class c, final String n, final Object o, final Object v )
    {
        ...
        {
            throw ExceptionTool.initCause(
                    new Error( "Invocation not allowed! (" + e + ")" ), e );
        }
    }
