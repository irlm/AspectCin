 ...
 * for the IBM JDKs 1.3.0 (JDKs where the orb shared
 * library is present).
 *
 * @author Michael Rumpf
 */
public class DeserializationKernelIBM
    implements DeserializationKernel
{
    private static final String
        REFLECT_FIELD_CLASS = "com.ibm.rmi.io.JNIReflectField";
    ...
    private static boolean loadORBLibrary()
    {
        ...
        try
        {
            Class libmgrClz = Class.forName( "com.ibm.rmi.io.LibraryManager" );
            Method method = libmgrClz.getDeclaredMethod( "load", new Class[] {} );
    ...
    /**
     * Get the field constructor from the class JNIReflectField.
     */
    ...
    /**
     * This method invokes the public methods on JNIReflectField.
     */
