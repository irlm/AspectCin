    ...
    implements org.omg.PortableInterceptor.PolicyFactory
{
    ...
    public synchronized org.omg.CORBA.Policy create_policy( int type, org.omg.CORBA.Any value )
        throws org.omg.CORBA.PolicyError
    {
        ...
        case SYNC_SCOPE_POLICY_TYPE.value:
            if ( !value.type().equal( SyncScopeHelper.type() )
                && value.type().kind() != TCKind.tk_short
                && value.type().kind() != TCKind.tk_ushort )
            {
    ...
    private SyncScopePolicy createSyncScopePolicy( short polValue )
        throws org.omg.CORBA.PolicyError
    {
        switch( polValue )
        {
