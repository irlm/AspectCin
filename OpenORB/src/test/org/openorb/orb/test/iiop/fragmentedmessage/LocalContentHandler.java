    ...
    extends DefaultHandler
{
    ...
    static
    {
        ATTRTYPECODE_2_ATTRENUM_MAP.put(
              STRING_ATTRIBUTE, AttributeEnum.StringAttr );
        ATTRTYPECODE_2_ATTRENUM_MAP.put(
              DIMENSION_ATTRIBUTE, AttributeEnum.Dimension );
        ATTRTYPECODE_2_ATTRENUM_MAP.put(
              DOUBLE_ATTRIBUTE, AttributeEnum.DoubleAttr );
        ATTRTYPECODE_2_ATTRENUM_MAP.put(
              BOOLEAN_ATTRIBUTE, AttributeEnum.BooleanAttr );
        ATTRTYPECODE_2_ATTRENUM_MAP.put(
              LONG_ATTRIBUTE, AttributeEnum.LongAttr );
        ATTRTYPECODE_2_ATTRENUM_MAP.put(
              DATE_ATTRIBUTE, AttributeEnum.DateAttr );
        ATTRTYPECODE_2_ATTRENUM_MAP.put(
              DATETIME_ATTRIBUTE, AttributeEnum.DateTime );
        ATTRTYPECODE_2_ATTRENUM_MAP.put(
              ENUMERATION_ATTRIBUTE, AttributeEnum.Enumerated );
        ATTRTYPECODE_2_ATTRENUM_MAP.put(
              USERLIST_ATTRIBUTE, AttributeEnum.UserList );
        ATTRTYPECODE_2_ATTRENUM_MAP.put(
              SEQUENCE_ATTRIBUTE, AttributeEnum.SequenceAttr );
        ATTRTYPECODE_2_ATTRENUM_MAP.put(
              STRINGBUFFER_ATTRIBUTE, AttributeEnum.StringBuffer );
        ATTRTYPECODE_2_ATTRENUM_MAP.put(
              STYLEDTEXT_ATTRIBUTE, AttributeEnum.StyledText );
    }
        ...
        throws org.xml.sax.SAXException
    {
        ...
        else
        {
            ...
            anAttributeType.type = ( AttributeEnum ) ATTRTYPECODE_2_ATTRENUM_MAP.get(
                  anAttributeEnumCode );
    ...
    public void endDocument()
        throws SAXException
    {
        //System.out.println( "Got end of document!!!!" );
    }
}
