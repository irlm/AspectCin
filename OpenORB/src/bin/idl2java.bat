@echo off
REM
REM $Id: idl2java.bat,v 1.4 2003/04/12 18:41:24 mrumpf Exp $
REM
...
if "%TCOO_HOME%" == "" goto setHome
    if exist "%TCOO_HOME%\OpenORB\bin\idl2java.bat" goto tcooHome
...
rem
%JAVA% -Xbootclasspath/p:%BOOTCLASSPATH% -Dopenorb.home.path=%TCOO_HOME% -jar %TCOO_HOME%\tools\lib\launcher.jar org.openorb.compiler.IdlCompiler %*
