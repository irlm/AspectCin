...
{
    private transient Delegate m_delegate;
    ...
    {
        return org.omg.CORBA.InterfaceDefHelper.narrow( _get_interface_def() );
    }
    ...
    public org.omg.CORBA.Request _create_request( org.omg.CORBA.Context ctx,
            String operation, org.omg.CORBA.NVList arg_list, org.omg.CORBA.NamedValue result )
    {
    ...
    public org.omg.CORBA.Request _create_request( org.omg.CORBA.Context ctx,
          String operation, org.omg.CORBA.NVList arg_list, org.omg.CORBA.NamedValue result,
          org.omg.CORBA.ExceptionList exceptions, org.omg.CORBA.ContextList contexts )
    {
    ...
    public String toString()
    {
        if ( m_delegate != null )
        {
            return m_delegate.toString( this );
        }
        else
        {
    ...
    public int hashCode()
    {
        if ( m_delegate != null )
        {
            return m_delegate.hashCode( this );
        }
        else
        {
    ...
    public boolean equals( java.lang.Object obj )
    {
        if ( m_delegate != null )
        {
            return m_delegate.equals( this, obj );
        }
        else
        {
            return ( this == obj );
