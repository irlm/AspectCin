    ...
    implements LogEnabled
{
     ...
     * @param name the property name.
     * @param defl default value to use if property not found.
     * @throws CascadingRuntimeException The property value is not parsable to an int.
     */
     ...
     * @param name the property name.
     * @param defl default value to use if property not found.
     * @throws CascadingRuntimeException The property value is not parsable to a URL.
     */
     ...
     * @throws CascadingRuntimeException the property value or default class cannot
