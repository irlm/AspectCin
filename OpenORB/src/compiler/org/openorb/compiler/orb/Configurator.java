 ...
 * @author Chris Wood
 * @version $Revision: 1.9 $ $Date: 2004/07/20 23:50:43 $
 */
public class Configurator
{
    // properties
    private org.openorb.compiler.orb.Properties m_props =
            new org.openorb.compiler.orb.Properties();
    ...
    //private static final String CONFIG_DTD = CONFIG_NS + "/OpenORB.dtd";
     ...
     * @param props
     */
    public Configurator( String[] args, Properties props )
    {
        setupHandler();
        ...
        {
            System.out.println( "WARNING: Security settings do not allow reading system properties."
     ...
     */
    public org.openorb.compiler.orb.Properties getProperties()
    {
        return m_props;
    }
    ...
    private void addProperty( String name, String value )
    {
        ...
        if ( name.startsWith( "org.openorb." ) )
        {
            if ( name.startsWith( "org.openorb.messaging.MessagingInitializerClass." ) )
            {
                ...
                m_initializers.add( value );
                 ...
                 || name.startsWith( "org.openorb.orb.rmi.InitializerClass." ) )
            {
                System.err.println (
                    "Non-standard initializer specification is deprecated: "
                    + "org.openorb.rmi.InitializerClass./org.openorb.orb.rmi.InitializerClass." );
        ...
        {
            m_props.addProperty( name, value );
        }
    }
    ...
    private void addProperties( String prefix, Properties props )
    {
        ...
        while ( enumeration.hasMoreElements() )
        {
            ...
            {
                System.out.println( "WARNING: The property '" + key
    ...
    private void setupHandler()
    {
        ...
        {
            System.out.println( "WARNING: The URLHandler could not be set! The security settings "
    ...
    private void parseSpecialArgs( String[] args, Properties props, Properties orbProps )
    {
        ...
        if ( val != null )
        {
            ...
            if ( url == null )
            {
                throw new RuntimeException( "Can't parse openorb.home property as a URL" );
            }
        ...
        else
        {
            try
            {
                //m_props.addProperty( "openorb.home", new URL( "resource:/org/openorb/" ) );
                m_props.addProperty( "openorb.home",
                  new URL( "resource", "", -1, "/org/openorb/",
            ...
            catch ( final MalformedURLException ex )
            {
                ...
                else
                {
                    throw new RuntimeException(
                            "Can't determine openorb.home property (" + ex + ")" );
                }
            }
        }
        ...
        if ( val != null )
        {
            ...
            if ( url == null )
            {
                throw new RuntimeException( "Can't parse openorb.config property as a URL" );
            }
    ...
    private URL findRootConfig()
    {
        ...
        throw new RuntimeException( "Unable to locate OpenORB.xml" );
    }
    ...
    private String handleURLImport( URL url )
    {
        ...
        else if ( !m_ignoreXML && file.endsWith( ".xml" ) )
        {
            return handleXMLImport( url );
        }
        else
        {
            throw new RuntimeException( "Unknown type for URL \"" + url + "\"" );
        }
    }
        ...
        try
        {
            ...
            if ( fragment != null )
            {
                ...
                catch ( final MalformedURLException ex )
                {
                    ...
                    throw new CascadingRuntimeException( msg, ex );
                }
            }
                ...
                if ( username != null )
                {
                    ...
                    case 1:
                        ...
                        for ( int i = 0; i < list.getLength() && fragment == null; ++i )
                        {
                            ...
                            {
                                throw new RuntimeException( "Association in \""
            ...
            if ( impElem == null )
            {
                ...
                if ( impElem == null )
                {
                    throw new RuntimeException( "Cannot find element \"" + url + "\"" );
                }
            }
        ...
        for ( int i = 0; i < list.getLength(); ++i )
        {
            ...
            if ( subtype.equals( "import" ) )
            {
                ...
                if ( !handleProperties( nextElem, impModule, null ) )
                {
                    ...
                    {
                        throw new RuntimeException( "Import statment in \""
    ...
    private String handleImportElem( Element impElem, URL url, boolean profile )
    {
        ...
        case 0 :
            if ( !profile )
            {
                throw new RuntimeException( "Import from \""
        ...
        case 1:
            ...
            {
                throw new RuntimeException( "Atribute "
        ...
        if ( profile )
        {
            if ( ret != null )
            {
                throw new RuntimeException( "Attempted to extend module \""
                      + importURL + "\" from profile \"" + url + "\"" );
            }
        }
        else if ( !hasLink && ( ret == null ? hasModule : hasProfile ) )
        {
            throw new RuntimeException( "Attempted to import "
    ...
    private void handlePropaliasElem( Element impElem, String module, URL url )
    {
        ...
        if ( name.length() == 0 )
        {
            throw new RuntimeException( "Propalias in \""
    ...
    private void handlePropertyElem( Element impElem, String module, URL url )
    {
        ...
        if ( name.length() == 0 )
        {
            throw new RuntimeException( "Property in \""
                  + url + "\" does not have a name" );
        }
        ...
        if ( impElem.hasAttribute( "root" ) )
        {
            ...
            {
                throw new RuntimeException( "Property " + name + " in \""
                                                    + url
