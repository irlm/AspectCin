 ...
 * to use the system identity hash code, instead of the class' hash code. Based on 
 * rev 1.53 from the jsr166 CVS tree (which works with the Java 1.5 rt.jar).
 * 
 * Written by Doug Lea with assistance from members of JCP JSR-166
 * Expert Group and released to the public domain, as explained at
 * http://creativecommons.org/licenses/publicdomain
 * 
 * This version is Java 5-specific, so it is packaged in a different project.
 */
...
public class ConcurrentIdentityHashMap<K, V> extends AbstractMap<K, V>
    ...
    /**
     * ConcurrentIdentityHashMap list entry. Note that this is never exported
    ...
    /**
     * Save the state of the <tt>ConcurrentIdentityHashMap</tt>
    ...
    /**
     * Reconstitute the <tt>ConcurrentIdentityHashMap</tt>
