...
import glassbox.simulator.resource.ftp.MockJakartaFtpClient;
...
public class JakartaFtpMonitorTest extends VirtualMockObjectTestCase {
    ...
    public void testSingleFastMethodMonitor() throws Exception {
        ...
        MockJakartaFtpClient ftp = new MockJakartaFtpClient();
        ftp.storeFile();
