  ...
  <tr>
    <td background="images/contentbg.gif" style="background-repeat:repeat-x"><table width="777" border="0" cellspacing="0" cellpadding="0">
      <tr>
	    ...
	    <h3>Application Server Startup Required Parameter <i><%=request.getAttribute("PARAM")%></i> Error</h3>
	    <br/>
	    ...
	    <li>Did you setup Glassbox on your Application Server? (Tomcat, WebSphere, etc)</li>
   	    ...
   	    <li>Check to make sure the environment variables defined by the launching script are not overridden and are passed through when starting your Java VM</li>
<% if(request.getAttribute("PARAM").equals("-Dglassbox.install.dir")) { %>
   	    <li>Check the script used to launch your application server to verify the <i>-Dglassbox.install.dir</i> parameter is present and set to a valid directory on your filesystem</li>
   	    <li>Verify the directory specified by the <i>-Dglassbox.install.dir</i> parameter contains a file named glassbox.properties
<% } %>
