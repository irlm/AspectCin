  ...
  <tr>
    <td background="images/contentbg.gif" style="background-repeat:repeat-x"><table width="777" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		</p><font color="red">*</font>Choose the type of Apache Tomcat server you are running:<br/>
		<form name="tomcatConfigForm" action="ConfigureInstall.form">
		<input type="radio" name="tomcatType" value="service" checked> Installed as Windows Service
		<input type="radio" name="tomcatType" value="script"> Using Startup Scripts (i.e. catalina.bat)
		<ul class="buttons">
